...
export = {
    ...
    "bot.not_admin": "操作失败，可能是群管并未赋予我<b>删除消息</b>、<b>限制群成员</b>和<b>封禁用户</b>权限。",
    "button.ban": "封禁",
    "button.pass": "通过",
    "callback.bad_data": "操作失败，按钮数据无效。",
    "callback.ban": "已封禁该用户。",
    "callback.expired": "该验证已结束。",
    "callback.not_admin": "只有有封禁权限的管理员可以操作。",
    "callback.pass": "已通过该用户的验证。",
